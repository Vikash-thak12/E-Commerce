...
const ProductCard = ({ product: { name, price, image, user } }: { product: ProductType }) => {
    return (
        <div className='border rounded-xl cursor-pointer hover:scale-105 transition-all hover:shadow-md hover:shadow-slate-500 bg-gray-400'>
            <Image src={image} alt={name} width={300} height={400} className='w-full rounded-t-xl' />
